...
class _CustomerSettingsPageState extends State<CustomerSettingsPage> {
  ...
  void _onTapVerifyAccount() {
    context.push(RoutePath.customerverifyAccount);
  }
            ...
            return Column(
              children: [
                GestureDetector(
                  ...
                  child: _buildAvatar(imageUrl, firstLetter, context),
                ),
                TextButton(
                  onPressed: _onTapEditImage,
  ...
  Widget _buildAvatar(
    ...
    if (imageUrl == null || imageUrl.isEmpty) {
      return CircleAvatar(
        radius: 36,
        child: Text(firstLetter, style: context.textStyle.largeTitle),
      );
    }
