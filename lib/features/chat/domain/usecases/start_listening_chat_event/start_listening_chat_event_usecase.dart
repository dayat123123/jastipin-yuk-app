...
class StartListeningChatEventUsecase implements UseCase<Result<void>, void> {
  final ChatRepository _repository;

  const StartListeningChatEventUsecase(this._repository);
  @override
  Future<Result<void>> call(void params) async {
    return await _repository.startListeningChatEvent();
  }
}
